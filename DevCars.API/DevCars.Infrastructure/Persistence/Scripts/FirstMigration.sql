...
CREATE TABLE [Cars] (
    ...
    [Marca] VARCHAR(100) NOT NULL DEFAULT 'PADRÃO',
...
CREATE TABLE [Orders] (
    ...
    CONSTRAINT [FK_Orders_Customers_IdCostumer] FOREIGN KEY ([IdCostumer]) REFERENCES [Customers] ([Id]) ON DELETE NO ACTION
);
GO
...
CREATE INDEX [IX_Orders_IdCostumer] ON [Orders] ([IdCostumer]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210403192926_FirstMigration', N'5.0.4');
GO
